...
namespace NHibernate.Caches.MemoryCache
{
	/// <summary>
	...
	public class MemoryCache : ICache
	{
        ...
        private readonly System.Runtime.Caching.ObjectCache cache;
		...
		private static CacheItemPriority ConvertCacheItemPriorityFromXmlString(string priorityString)
		{
			...
			if(ps.Length == 1 && char.IsDigit(priorityString,0))
			{
                ...
                if (priorityAsInt >= 0 && priorityAsInt <= 1)
                {
		...
		public void Put(object key, object value)
		{
            ...
            cachePolicy.ChangeMonitors.Add(this.cache.CreateCacheEntryChangeMonitor(new[] { rootCacheKey }));
            cachePolicy.AbsoluteExpiration = DateTime.Now.Add(expiration);
            cachePolicy.SlidingExpiration = ObjectCache.NoSlidingExpiration;
            cachePolicy.Priority = this.priority;
