...
namespace NHibernate.Caches.MemoryCache.Tests
{
    ...
    public class MemoryCacheFixture
	{
		...
		{
            ICache cache = new MemoryCache("nunit");
			Assert.IsNotNull(cache);
		}
		...
		public void TestPriorityOutOfRange()
		{
            ...
            Assert.Throws<IndexOutOfRangeException>(() => new MemoryCache("nunit", h));
		}
		...
		public void TestBadRelativeExpiration()
		{
            ...
            Assert.Throws<ArgumentException>(() => new MemoryCache("nunit", h));
		}

		[Test]
		public void TestEmptyProperties()
		{
            ICache cache = new MemoryCache("nunit", new Dictionary<string, string>());
			Assert.IsNotNull(cache);
		}
		...
		public void TestAfterClearCanPut()
		{
			...
			Assert.IsTrue(System.Runtime.Caching.MemoryCache.Default.GetCount() > 0, "cache is empty");

			// clear the System.Web.HttpRuntime.Cache
			IList keys = new ArrayList();

            IDictionaryEnumerator entry = (IDictionaryEnumerator)((IEnumerable)System.Runtime.Caching.MemoryCache.Default).GetEnumerator();
            ...
            Assert.AreEqual(0, System.Runtime.Caching.MemoryCache.Default.GetCount(), "cache isn't empty");
